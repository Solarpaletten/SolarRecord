...
export default function RecordsPage() {
  ...
  const deleteRecording = async (recordingId: string) => {
    ...
    try {
      const response = await fetch(`${API_URL}/files/${recordingId}`, {
        method: "DELETE"
      });
              ...
              >
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {/* View Video */}
                    <a
                      href={`${API_URL}/static/video/${recording.filename}`}
                      target="_blank"
                    ...
                    {recording.transcript_path ? (
                      <button
                        onClick={() => {
                          window.open(`${API_URL}/static/transcripts/${recording.id}.txt`, "_blank");
                        }}
                    ...
                    {recording.transcript_path && !recording.translated ? (
                      ...
                      <button
                        onClick={() => {
                          ...
                          window.open(`${API_URL}/static/transcripts/${recording.id}_${langCode}.txt`, "_blank");
                        }}
