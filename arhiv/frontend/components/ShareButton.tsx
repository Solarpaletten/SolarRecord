...
export default function ShareButton({ recording }: ShareButtonProps) {
  ...
  const handleShare = async () => {
    try {
      ...
      const syncResponse = await fetch("http://localhost:8000/api/recorder-sync", {
        method: "POST",
        headers: {
      ...
      // Simulate sending notification (in real app, this would call notification API)
